...
import {
    registerGLTFLoader
} from '../../components/loaders/gltf-loader'
            ...
            initVK() {
                ...
                session.start(err => {
                    ...
                    session.on('updateAnchors', anchors => {
                        ...
                        if(this.data.anchor2DList != null && this.data.anchor2DList.length > 0) {
                          
                          // console.log('triggerEvent: customerUpdateAnchor ' + JSON.stringify(this.data.anchor2DList[0]))
                          this.onCustomerUpdateAnchor(this.data.anchor2DList[0])
                          // this.triggerEvent('customerupdateanchor', anchors[0], {composed: true, bubbles:true})
                        }
                    })
                    session.on('removeAnchors', anchors => {
                        this.data.anchor2DList = []
                        this.onCustomerRemoveAnchor()
                    })
